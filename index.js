...
const foyer = new Room('Foyer', 'You stand in the middle of a small room with peeling, yellowed wallpaper. The door to outside is to one side and to the other, sits a door that leads into what looks like the lounge.', [])

const lounge = new Room('Lounge', 'Entering the lounge, you see furniture draped in sheets that are covered in dust and mold. The air is thick and stagnant and the little light that shines through the film on the windows casts a brown tint throughout the room. There is a dusty table in front of the couch and on it sits an old newspaper, yellowed by time. On one side of the room is a flight of stairs going down to the basement. The opposite side has a hallway. To the far side of the room is a door that leads to the Kitchen. Behind you is the door back to the Foyer. ', ['newspaper'])

const kitchen = new Room('Kitchen', 'The kitchen is filthy. The countertop against the wall in front of you is covered in a brown sticky film. In the middle of the floor there is a broom broken into a few pieces, one of the pieces looks like it would make a good stake. Six cabinets sit underneath the countertop but only two have doors, in the others you can see there\'s some garlic and what looks to be an empty bag of candycorn. Above the countertop sit another four cabinets all with doors intact. A refrigerator sits against one wall and appears to be running. The oven against the opposite wall also seems to be in working as well. The smell of a roast fills the air. You seem put off by it but also quite curious. The door to the lounge is behind you.', ['roast', 'garlic', 'stake', 'candycorn'])

const hallway = new Room('Hallway', 'Leaving the lounge, you turn and see a small hallway with a filthy window at the end. There are two doors on either side of the hallway, one looks like the Master Bedchamber and the other looks to be a little girl\s bedroom.', [])
